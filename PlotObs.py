...
if __name__=='__main__':
    ...
    map_fig, map_ax = plt.subplots(1,1, figsize=(12,7))
    dims = {'xoffset':0, 'yoffset':-0.5, 'cmap':cm.YlOrRd, 'dims':[150,80], 'center':[10,-35], 'ra':'alphawin_j2000_i', 'dec':'deltawin_j2000_i', 'meridians':np.arange(0,360,20)}
    suchyta_utils.plot.MapPlot(ax=map_ax, fig=map_fig, cat=sim, **dims)
    map_ax.set_title(r'Source (\textsc{Balrog})')
